               ...
               <div id="carouselExampleCaptions" class="slide" >
                  ...
                  <div class="carousel-inner">
                     ...
                     <div class="carousel-item active">
                        <img class="d-block w-100 dek-banner-1"  alt="homebanner" src="<?php echo get_field('banner');?>" data-holder-rendered="true"> 
                        
                        <img class="mobile-banner-1" src="<?php echo get_field('mobile_banner');?>" alt=""> 
                        
                        <div class="carousel-caption d-md-block">

                           <h1 class="font-50 font-wei-300 line-height-75">Your <div id="app" class="bg-saffron pd-3" style="display:inline;"></div> Partners <br>
                              Today &amp; Tomorrow. 
                           </h1>
                           <a href="#" class="btn wo-btn mg-top-15">READ MORE</a> 
                        </div>
                     </div>
         ...
         <div class="bd-example wo-usp">
            <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-3 <?php echo $color;?>  pg-left-15 pg-right-15 bd-right-1 usp-wp">
                            <div class="media">
                                <img class="align-self-end mr-3" src="<?php echo esc_url( $image['url'] ); ?>" alt="icons"> 
                     ...
                     <div class="row">
                                                ...
                                                ?>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                          <div class="box-part text-left pg-top-20 pg-bottom-20 mg-top-30 mg-bottom-0">
                                                                        <img class="pg-bottom-20" src="<?php the_field('solution_icon');?>" alt=""> 
                                                ...
                                                <span class="font-wei-blod font-16 wt-clo bg-saffron pd-2 text-uppercase"><?php echo $solutions_title;?></span>
                                                  ...
                                                  <p><?php echo $solutions_content;?> </p>
                                                      ...
                                                      <div class="text-center text-md-left">   
                                                            <a class="btn wo-btn mg-top-15" href="<?php echo esc_url($solutions_button_link);?>"><?php echo $solutions_button;?></a> 
                                                      </div> 
                                                </div>
            ...
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-12 col-md-7 col-lg-7 order-md-1 aos-init aos-animate" data-aos="fade-up">
                     <span class="font-wei-blod font-16 wt-clo bg-saffron pd-2 text-uppercase"><?php echo get_sub_field('about_title');?></span> 
                     <!-- Heading -->
                  ...
                  <div class="col-12 col-md-5 col-lg-5">
                     <!-- Image --> 
                     <img src="<?php echo get_sub_field('about_us_image');?>" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0 aos-init aos-animate" alt="about us" data-aos="fade-up" data-aos-delay="100"> 
                  </div>
               </div>
...
<section class="pt-md-11 sec-5 pg-top-80 pg-bottom-100 bg-vt-sec3">
            <div class="container">
               <div class="row align-items-center">
                  <span class="text-center font-wei-blod font-16 wt-clo bg-saffron pd-2 text-uppercase m-auto">calculator</span>
                  ...
                  <div class="col-12 col-md-7 col-lg-7 aos-init aos-animate pg-top-40" data-aos="fade-up">
                     <div class="form-check form-check-inline">
                        <input class="form-check-input font-18 font-wei-400" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                        <label class="form-check-label font-18 font-wei-400" for="inlineRadio1">I Know My Goal</label>
                     </div>
                     <div class="form-check form-check-inline">
                        <input class="form-check-input font-18 font-wei-400" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                        <label class="form-check-label font-18 font-wei-400" for="inlineRadio2">I Know My Goal</label>
                     </div>
                     <div class="range-slider">
                        <div class="range-cad-1"> <span class="font-18 font-wei-400 pull-left">I need Rs.</span> <span class="font-18 font-wei-400 pull-right range-pri">
                           <input type="text" class="form-control" placeholder="5,00,000">
                           </span> 
                        </div>
                        <input class="range-slider__range font-18 font-wei-400" type="range" value="100" min="0" max="500">
                        <span class="range-slider__value font-18 font-wei-400">100</span> 
                        <div class="range-cad-2"> <span class="font-18 font-wei-400 pull-left bl-light-clo">5L</span> <span class="font-18 font-wei-400 pull-right bl-light-clo">5CR</span> </div>
                     </div>
                     <div class="range-slider">
                        <div class="range-cad-1"> <span class="font-18 font-wei-400 pull-left">No. of years</span> </div>
                        <input class="range-slider__range font-18 font-wei-400" type="range" value="250" min="0" max="500" step="50">
                        <span class="range-slider__value font-18 font-wei-400">250</span> 
                        <div class="range-cad-2"> <span class="font-18 font-wei-400 pull-left bl-light-clo">5L</span> <span class="font-18 font-wei-400 pull-right bl-light-clo">5CR</span> </div>
                     </div>
                     <div class="range-slider">
                        <div class="range-cad-1"> <span class="font-18 font-wei-400 pull-left">Expected of Return</span> </div>
                        <input class="range-slider__range font-18 font-wei-400" type="range" value="400" min="0" max="500">
                        <span class="range-slider__value font-18 font-wei-400">400</span> 
                        <div class="range-cad-2"> <span class="font-18 font-wei-400 pull-left bl-light-clo">5L</span> <span class="font-18 font-wei-400 pull-right bl-light-clo">5CR</span> </div>
                     </div>
                  </div>
                  <div class="col-12 col-md-5 col-lg-5">
                     <div class="wo-sip bg-light-black">
                        <h5 class="display-3 text-center font-30 font-wei-300 bl-clo line-height-40 pg-top-5 w-100">Monthly SIP Amount</h5>
                        <h5 class="display-3 text-center font-30 font-wei-300 bl-clo line-height-40 pg-top-5 w-100">₹18500</h5>
                        <a href="#" class="btn wo-btn mg-top-15">SEND</a> 
                     </div>
                  </div>
               </div>
            </div>
...
<div class="col-12 col-md-12 col-lg-11 aos-init aos-animate mg-bottom-30" data-aos="fade-up">
            ...
            <?php while( have_rows('case_study') ): the_row(); ?>
                  ...
                  <div class="col-12 col-md-6 col-lg-6 mo-wo-center">
                     <span class="font-wei-blod font-16 wt-clo bg-saffron pd-2 text-uppercase"><?php echo get_sub_field('case_study_title');?></span> 
                     <!-- Heading -->
...
<section class="pt-md-11 pg-top-60 pg-bottom-60 wo-insta-post about-bg-sec2">
            <div class="container">
               <div class="row align-items-center">
                  <span class="text-center font-wei-blod font-16 wt-clo bg-saffron pd-2 text-uppercase m-auto">our Feed</span>
